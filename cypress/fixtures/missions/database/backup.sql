...
(`activityLoginId`),
  KEY `updatedById`
(`updatedById`),
  CONSTRAINT `activitylogin_ibfk_1` FOREIGN KEY
(`updatedById`) REFERENCES `app_user`
(`userId`) ON
DELETE NO ACTION ON
UPDATE CASCADE
) ENGINE=InnoDB
...
app_role`
VALUES
  (1, 'ROLE_PATIENT', 'ROLE_PATIENT', '1983-10-10 10:00:00', '1983-10-10 10:00:00'),
  (2, 'ROLE_ADMIN', 'ROLE_ADMIN', '1983-10-10 10:00:00', '1983-10-10 10:00:00');
...
app_user`
VALUES
  (1, 'admin@ocariot.com', 'admin', 'admin', 'admin', NULL, NULL, NULL, '$2b$10$BPF.48tRghRwLOs52.ljpOC73ZtL94brWt68tGxCphvZVpMx7sAY.', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2019-07-12 09:16:13', '2019-07-12 09:16:13');
...
(`ardenRuleId`),
  KEY `userId`
(`userId`),
  CONSTRAINT `ardenrule_ibfk_1` FOREIGN KEY
(`userId`) REFERENCES `app_user`
(`userId`) ON
DELETE NO ACTION ON
UPDATE CASCADE
...
(11) DEFAULT NULL,
  ...
  `updatedAt` datetime NOT NULL,
  PRIMARY KEY
(`ardenRuleForPatientId`),
  KEY `userId`
(`userId`),
  KEY `ardenRuleId`
(`ardenRuleId`),
  CONSTRAINT `ardenruleforpatient_ibfk_1` FOREIGN KEY
(`userId`) REFERENCES `app_user`
(`userId`) ON
DELETE NO ACTION ON
UPDATE CASCADE,
  CONSTRAINT `ardenruleforpatient_ibfk_2` FOREIGN KEY
(`ardenRuleId`) REFERENCES `ardenrule`
(`ardenRuleId`) ON
DELETE NO ACTION ON
UPDATE CASCADE
) ENGINE=InnoDB
...
(`id`),
  KEY `missionId`
(`missionId`),
  CONSTRAINT `missionId` FOREIGN KEY
(`missionId`) REFERENCES `educator_mission`
(`id`) ON
DELETE NO ACTION ON
UPDATE NO ACTION
) ENGINE=InnoDB
...
custom_migrations`
VALUES
  (1, '1581334233044', '2020-03-03 21:17:01', '2020-03-03 21:17:01'),
  (2, '1581511158709', '2020-03-03 21:17:01', '2020-03-03 21:17:01'),
  (3, '1581665116228', '2020-03-03 21:17:01', '2020-03-03 21:17:01'),
  (4, '1581675088859', '2020-03-03 21:17:01', '2020-03-03 21:17:01'),
  (5, '1581677172319', '2020-03-03 21:17:01', '2020-03-03 21:17:01'),
  (6, '1581680129494', '2020-03-03 21:17:01', '2020-03-03 21:17:01'),
  (7, '1581926198773', '2020-03-03 21:17:02', '2020-03-03 21:17:02'),
  (8, '1582022609323', '2020-03-03 21:17:02', '2020-03-03 21:17:02'),
  (9, '1582030041473', '2020-03-03 21:17:02', '2020-03-03 21:17:02');
...
(255) DEFAULT NULL,
  `durationNumber` int
(11) DEFAULT NULL,
  `childRecommendation` varchar
(255) DEFAULT NULL,
  `parentRecommendation` varchar
(255) DEFAULT NULL,
  `createdAt` datetime NOT NULL,
  `updatedAt` datetime NOT NULL,
  PRIMARY KEY
...
(`notificationId`),
  KEY `notifyUserId`
(`notifyUserId`),
  CONSTRAINT `notifications_ibfk_1` FOREIGN KEY
(`notifyUserId`) REFERENCES `app_user`
(`userId`) ON
DELETE NO ACTION ON
UPDATE CASCADE
) ENGINE=InnoDB
...
(11) DEFAULT NULL,
  ...
  `ardenResult` int
(11) DEFAULT NULL,
  `measureFhirId` varchar
(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY
(`id`),
  KEY `userId`
(`userId`),
  CONSTRAINT `observation_ibfk_1` FOREIGN KEY
(`userId`) REFERENCES `app_user`
(`userId`) ON
DELETE NO ACTION ON
UPDATE CASCADE
...
(`patientAuditId`),
  KEY `patientId`
(`patientId`),
  CONSTRAINT `patientaudit_ibfk_1` FOREIGN KEY
(`patientId`) REFERENCES `app_user`
(`userId`) ON
DELETE NO ACTION ON
UPDATE CASCADE
) ENGINE=InnoDB
...
(`id`),
  KEY `robot_result_id`
(`robot_result_id`),
  CONSTRAINT `robot_result_log_ibfk_1` FOREIGN KEY
(`robot_result_id`) REFERENCES `robot_result`
(`id`) ON
DELETE CASCADE ON
UPDATE CASCADE
) ENGINE=InnoDB
...
(`id`),
  KEY `robot_result_id`
(`robot_result_id`),
  CONSTRAINT `robot_result_mission_ibfk_1` FOREIGN KEY
(`robot_result_id`) REFERENCES `robot_result`
(`id`) ON
DELETE CASCADE ON
UPDATE CASCADE
...
(`userId`),
  KEY `ruleId`
(`ruleId`),
  CONSTRAINT `ruleresult_ibfk_1` FOREIGN KEY
(`userId`) REFERENCES `app_user`
(`userId`) ON
DELETE NO ACTION ON
UPDATE CASCADE,
  CONSTRAINT `ruleresult_ibfk_2` FOREIGN KEY
(`ruleId`) REFERENCES `ardenrule`
(`ardenRuleId`) ON
DELETE NO ACTION ON
UPDATE CASCADE
) ENGINE=InnoDB
...
(`userId`,`roleId`),
  KEY `roleId`
(`roleId`),
  CONSTRAINT `users_roles_ibfk_1` FOREIGN KEY
(`userId`) REFERENCES `app_user`
(`userId`) ON
DELETE CASCADE ON
UPDATE CASCADE,
  CONSTRAINT `users_roles_ibfk_2` FOREIGN KEY
(`roleId`) REFERENCES `app_role`
(`roleId`) ON
DELETE CASCADE ON
UPDATE CASCADE
) ENGINE=InnoDB
