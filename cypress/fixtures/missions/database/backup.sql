...
--
-- Table structure for table `activity_tracker_data`
--

DROP TABLE IF EXISTS `activity_tracker_data`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `activity_tracker_data` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `childId` varchar(255) NOT NULL,
  `activityValue` varchar(255) NOT NULL,
...
--
-- Dumping data for table `activity_tracker_data`
--

LOCK TABLES `activity_tracker_data` WRITE;
/*!40000 ALTER TABLE `activity_tracker_data` DISABLE KEYS */;
/*!40000 ALTER TABLE `activity_tracker_data` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `baseline_answers`
--

DROP TABLE IF EXISTS `baseline_answers`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `baseline_answers` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `questionId` varchar(45) COLLATE utf8_unicode_ci NOT NULL,
  `answerValue` varchar(45) COLLATE utf8_unicode_ci NOT NULL,
  `childId` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `createdAt` datetime NOT NULL,
  `updatedAt` datetime NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
--
-- Dumping data for table `baseline_answers`
--

LOCK TABLES `baseline_answers` WRITE;
/*!40000 ALTER TABLE `baseline_answers` DISABLE KEYS */;
/*!40000 ALTER TABLE `baseline_answers` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `custom_migrations` VALUES (1,'1581334233044','2020-06-23 15:56:36','2020-06-23 15:56:36'),(2,'1581511158709','2020-06-23 15:56:36','2020-06-23 15:56:36'),(3,'1581665116228','2020-06-23 15:56:36','2020-06-23 15:56:36'),(4,'1581675088859','2020-06-23 15:56:36','2020-06-23 15:56:36'),(5,'1581677172319','2020-06-23 15:56:36','2020-06-23 15:56:36'),(6,'1581680129494','2020-06-23 15:56:36','2020-06-23 15:56:36'),(7,'1581926198773','2020-06-23 15:56:36','2020-06-23 15:56:36'),(8,'1582022609323','2020-06-23 15:56:36','2020-06-23 15:56:36'),(9,'1582030041473','2020-06-23 15:56:36','2020-06-23 15:56:36'),(10,'1583476505228','2020-06-23 15:56:36','2020-06-23 15:56:36'),(11,'1583766204228','2020-06-23 15:56:36','2020-06-23 15:56:36'),(12,'1583922122078','2020-06-23 15:56:36','2020-06-23 15:56:36'),(13,'1588422312900','2020-06-23 15:56:36','2020-06-23 15:56:36'),(14,'1588929532817','2020-06-23 15:56:36','2020-06-23 15:56:36');
...
CREATE TABLE `educator_mission` (
  ...
  `childRecommendation` text,
  `parentRecommendation` text,
  `createdAt` datetime NOT NULL,
  `updatedAt` datetime NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
-- Dump completed on 2020-06-23 16:10:06