...
describe('Q501PhysicalActivityForChildren', () => {
    ...
    describe('Test cases: ', () => {
        ...
        it('Saving a fully answered Q501PhysicalActivityForChildren', () => {
            ...
            cy.createQuest(questResource.Q501PhysicalActivityForChildren, defaultQ501, accessTokenDefaultEducator)
        ...
        it('When updating some fields in the Q501PhysicalActivityForChildren', () => {
            ...
            cy.updateQuest(questResource.Q501PhysicalActivityForChildren, defaultQ501, accessTokenDefaultEducator)
