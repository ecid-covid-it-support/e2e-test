...
describe('Q501PhysicalActivityForChildren', () => {
    ...
    it(`When the number of fields in "percentage" is greater than the number 
        of pages in the Q501PhysicalActivityForChildren`, () => {

        completeQ501.child_id = defaultChild01.username
        completeQ501.percentage = 'true, true, true, true, true, true'
